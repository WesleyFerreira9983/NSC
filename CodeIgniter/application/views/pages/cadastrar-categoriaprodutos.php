			...
			<?php if( $_SESSION['permissao'] ==  1 || $_SESSION['permissao'] ==  2){ ?>
			  ...
			  <?php } if( $_SESSION['permissao'] ==  1){ ?>
			   <li class="nav-item active">
                <a href="<?php echo base_url(); ?>?p=categoriaprodutos&typ=0" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
...
<?php } ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cadastrar Categorias do Produto</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Cadastrar Categorias do Produto</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <form name="Formulario" id="Formulario"  role="form" method="post" action="?p=inicio&typ=0" enctype="multipart/form-data">
                ...
                <div class="card-footer">
				  <button type="submit" id="cadastrar" name="cadastrarCategoria" class="btn btn-primary">Cadastrar</button>				  
  ...
  <script>
	   ...
	   function VerificaDados() {
		...
		var url_a  = "<?php print base_url(); ?>"+"assets/theme/myScripts/validarCategoriaProdutos.php";
