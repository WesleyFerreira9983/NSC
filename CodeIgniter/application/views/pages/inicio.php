<?php 
	...
	{	
		InserirUsuarios($conexao,$_POST["cpf"],$_POST["nome"],$_POST["sobrenome"],$_POST["email"],$_POST["senha"],
		$_POST["telefone"],$_POST["celular"],$_POST["nivelacesso"],$_POST["datanascimento"],$_POST["departamento"],$_POST["superiorresponsavel"]);
		$resultado = true;
	}
	
	if(isset($_POST["cadastrarDepartamento"]))
	{	
		InserirDepartamento($conexao,$_POST["nome"],$_POST["superiorresponsavel"]);
		$resultado = true;
	}
	
	if(isset($_POST["cadastrarProduto"]))
	{	
		InserirProduto($conexao,$_POST["nome"],$_POST["descricao"],$_POST["quantidade"],$_POST["preco"]
	...
	{	
		InserirCategoria($conexao,$_POST["nome"]);
		$resultado = true;
	}

 ?>	
		   <li class="nav-item has-treeview">
			<a href="<?php echo base_url(); ?>?p=inicio" class="nav-link active">
...
<?php } ?>
  ...
  <div class="content-wrapper">
	...
	if($resultado != false)
	{ ?>
	<div id="Notification" class="alert alert-success" style="position:absolute;z-index:999;right:10px;top:10px">
		<strong>Success!</strong> Agora o conteúdo pode ser acessado!.
	</div>   
	<?php } ?>			
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>?p=login">Home</a></li>
